    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='users_avatars/', verbose_name='Аватар')),
                ('role', models.CharField(choices=[('user', 'user'), ('admin', 'admin')], default='user', max_length=10, verbose_name='Роль пользователя')),
                ('activation_code', models.CharField(blank=True, max_length=32, null=True, verbose_name='activation_code')),
